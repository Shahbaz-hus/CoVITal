...
class DetailedGuidelines extends StatefulWidget {
  @override
  _DetailedGuidelinesState createState() => _DetailedGuidelinesState();
}

class _DetailedGuidelinesState extends State<DetailedGuidelines> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  SvgPicture.asset("assets/svg/detailedGuidelines.svg"),
                  SizedBox(
                    height: size.height * 0.05,
                  ),
                  Container(
